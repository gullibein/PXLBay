/**
 * PXLRogue High Score Proxy & Anti-Cheat Validation Service
 * Cloudflare Worker (Single-file self-contained)
 */
...
async function handleRequest(request, env = {}) {
  ...
  const binId = env.HS_BIN || DEFAULT_BIN;
  const accessKey = env.HS_KEY || env.JSONBIN_ACCESS_KEY;
